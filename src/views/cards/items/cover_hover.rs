...
use eframe::egui::{self, Color32, Label, RichText, Sense, Stroke, Vec2};
...
fn draw_badge_with_overlay(
    ...
    painter.rect_filled(
        rect,
        crate::ui_constants::card::STATS_ROUNDING,
        bg_color,
    );
    painter.rect_stroke(
        rect,
...
pub fn draw_cover(
    ...
    if !drew_image {
        if let Some(tex) = cover {
            ...
            p.rect_filled(
                cover_rect,
                crate::ui_constants::card::ROUNDING,
            ...
            match anim_pref {
                crate::app::settings::store::LoadingAnim::BottomBar => {
                    ...
                    ui.painter_at(cover_rect)
                        .rect_filled(line_rect, 0.0, color);
                }
